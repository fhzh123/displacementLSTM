...
#input_file_X="X.csv"
#input_file_Y="Y.csv"
input_file="ACCSTRAIN_DISPL_balance.mat"
...
'''
'''
Ref=displ_scaler.inverse_transform(np.reshape(dataset[:, 2], (-1, 1)))
# export prediction and actual prices
df = pd.DataFrame(data={"Predicted_Displ_train": np.around(list(trainPredict.reshape(-1)), decimals=2)})
df.to_csv("Predicted_Displ_train.csv", sep=';', index=None)
